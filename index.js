...
const setLocalData = (key, value) => {
     ...
     if (key === "content") {
          ...
          if (value.trim().length === 0)
               data['content'] = "Write something and save it in your local storage..!";
     }
...
const setTextFieldData = () => {
     let data = JSON.parse(window.localStorage.getItem("data")) ?? { content: "Write something and save it in your local storage..!" };
...
saveButton.addEventListener("click", () => {
     let text = String(textContent.value);
